...
**提交 PR 前**：请阅读并同意 [贡献者许可协议 (CLA)](./CLA.md)。这是维持本项目双许可模式所必需的。

## 许可证

PyClaw 采用双重许可模式：

- **[AGPL-3.0](./LICENSE)** — 开源项目、个人使用、企业内部使用免费
- **[商业许可](./COMMERCIAL-LICENSE.md)** — 闭源产品或 SaaS 服务需购买商业许可

商业许可咨询请联系 `timeflying2018@gmail.com`。
